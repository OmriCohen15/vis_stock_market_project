...
(function() {
  ...
  var filePaths = ['./data/STOCKHISTORY_QQQ.csv', './data/STOCKHISTORY_SPY.csv', './data/STOCKHISTORY_ACWI.csv', './data/STOCKHISTORY_SOXX.csv'];
  filePaths.forEach(function(filePath, counter) {
    d3.csv(filePath, type, function(err, data) {
      ...
      var priceChart = focus.append('path')
          ...
          .attr('d', priceLine)
          .style("stroke", colors[counter]); // Set the line color to blue
